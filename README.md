...
### v0.1 — Core Framework (this implementation)
- [x] Project scaffolding and core abstractions
- [x] Four implicit pattern detectors
- [x] Boundary enforcement, memory grounding, structured inference layers
- [x] Hybrid 2-sample uncertainty estimator
- [x] Guardrail monitor and reactive trigger system
- [x] Dynamic correction engine with backtracking and multi-pass forcing
- [x] `ReactiveReasoningLoop` orchestrator
- [x] Evaluation harness (pattern injection, uncertainty calibration, adversarial boundary)
- [x] Minimal examples and documentation
